...
const TASK_COMPLEXITY: Record<string, TaskComplexity> = {
  ...
  // Cheap classification / memory plumbing — Gemini Flash tier.
  "semantic-dedup":             "routine",
  "knowledge-decay-eligibility":"routine",
  ...
  "red-flag-generation":          "frontier-factual",
  "red-flag-severity":            "frontier-factual",
  "evidence-evaluation":          "frontier-factual",
  "evidence-quality-scoring":     "frontier-factual",
  "evidence-resolution":          "frontier-factual",
  "contradiction-detection":      "frontier-factual",
  "data-availability-assessment": "frontier-factual",

  // ── Frontier-reasoning — Claude Opus 4.6 ──
  // Pure reasoning / synthesis, identity-shaping tasks; factual freshness
  // matters less than long-context structural thinking.
  "deep-reasoning":                  "frontier-reasoning",
  "synthesis-report":                "frontier-reasoning",
  "architecture":                    "frontier-reasoning",
  "architecture-decision":           "frontier-reasoning",
  "code-reasoning":                  "frontier-reasoning",
  "complex-code-reasoning":          "frontier-reasoning",
  "triad-reasoning":                 "frontier-reasoning",
  "logic-map-generation":            "frontier-reasoning",
  "aspiration-generation":           "frontier-reasoning",
  "self-evolution-reflection":       "frontier-reasoning",
  "self-evolution-insight-generation":"frontier-reasoning",
  "theme-summary-generation":        "frontier-reasoning",
