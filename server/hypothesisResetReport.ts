...
const BUCKET_RECOMMENDED_ACTION: Readonly<Record<ResetBucket, string>> = Object.freeze({
  ...
  already_archived:              "No action — these records have already been archived by a prior reset apply. They are listed for audit only and the CLI will refuse to re-apply them.",
