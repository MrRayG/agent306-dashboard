...
async function renderCinematicTrailer(
  ...
  for (let f = 0; f < TOTAL; f++) {
    ...
    if (t >= 15) {
      ...
      drawText(ctx, "@306Agent", rx, CANVAS_H / 2 + 46, { size: 16, color: "#2dd4bf", alpha, font: "Courier New" });
...
async function renderHighlightReel(
  ...
  for (let f = 0; f < TOTAL; f++) {
    ...
    drawText(ctx, "@306Agent", CANVAS_W - 40, 54, { size: 11, color: "rgba(249,115,22,0.6)", align: "right", font: "Courier New" });
